...
- **Expected**: The skill flow results in `mcp__proj__config_init` being called with:
  ...
  - No `mcp__plugin_proj_proj__sandbox_sandbox_batch_setup` call (perms not installed).
...
- **Expected**: The skill flow results in:
  ...
  - `mcp__plugin_proj_proj__sandbox_sandbox_batch_setup` called with `mcp_servers` list containing: `"claude_ai_Excalidraw"`, `"claude_ai_Mermaid_Chart"`, `"plugin_proj_proj"`, `"plugin_sandbox_sandbox"`, `"plugin_worktree_worktree"`.
  - `mcp__plugin_proj_proj__sandbox_sandbox_add_write_path` called with `entry="Bash(zoxide *)"`.
- **Assert**:
...
- **Expected**: The skill flow results in:
  ...
  - `mcp__plugin_proj_proj__sandbox_sandbox_batch_setup` called with `mcp_servers` list including `"claude_ai_Todoist"`.
- **Assert**:
