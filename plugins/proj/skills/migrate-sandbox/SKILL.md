...
allowed-tools: mcp__perms__perms_backup, mcp__perms__perms_restore, mcp__perms__perms_sandbox_init, mcp__perms__perms_cleanup_stale, mcp__perms__perms_list, mcp__proj__config_load, mcp__proj__proj_list, mcp__proj__proj_get, Bash
