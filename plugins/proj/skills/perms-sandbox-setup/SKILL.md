...
allowed-tools: mcp__plugin_perms_perms__perms_is_sandbox_enabled, mcp__plugin_perms_perms__perms_sandbox_init, mcp__plugin_perms_perms__perms_batch_setup, mcp__plugin_perms_perms__perms_list
context: fork
