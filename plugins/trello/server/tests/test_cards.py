...
class TestGetCardsByListId:
    def test_returns_cards(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        cards_data = [
            {"id": "c1", "name": "Card 1"},
            {"id": "c2", "name": "Card 2"},
        ]
    ...
    def test_returns_empty_list(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
...
class TestGetCard:
    def test_returns_card(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
...
class TestAddCardToList:
    def test_adds_card_minimal(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
    ...
    def test_adds_card_with_desc(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
    ...
    def test_adds_card_with_due(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        mock_trello_client.post.return_value = {"id": "c3"}
    ...
    def test_empty_desc_omitted(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        mock_trello_client.post.return_value = {"id": "c3"}
        card_tools["add_card_to_list"]("list1", "Card", desc="")
        _, kwargs = mock_trello_client.post.call_args
        assert "desc" not in kwargs["params"]

    def test_none_due_omitted(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        mock_trello_client.post.return_value = {"id": "c3"}
...
class TestUpdateCardDetails:
    def test_updates_name(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        ...
        mock_trello_client.put.assert_called_once_with("/cards/c1", params={"name": "Updated"})
        assert json.loads(result) == updated

    def test_updates_desc(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
    ...
    def test_updates_due(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        mock_trello_client.put.return_value = {"id": "c1"}
        card_tools["update_card_details"]("c1", due="2026-12-31")
        _, kwargs = mock_trello_client.put.call_args
        assert kwargs["params"]["due"] == "2026-12-31"

    def test_updates_closed(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
    ...
    def test_updates_all_fields(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        mock_trello_client.put.return_value = {"id": "c1"}
        card_tools["update_card_details"]("c1", name="N", desc="D", due="2026-01-01", closed=False)
        _, kwargs = mock_trello_client.put.call_args
        assert kwargs["params"] == {
            "name": "N",
            "desc": "D",
    ...
    def test_none_fields_omitted(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        mock_trello_client.put.return_value = {"id": "c1"}
...
class TestMoveCard:
    def test_moves_card(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        moved = {"id": "c1", "idList": "list2"}
        mock_trello_client.put.return_value = moved

        result = card_tools["move_card"]("c1", "list2")

        mock_trello_client.put.assert_called_once_with("/cards/c1", params={"idList": "list2"})
        assert json.loads(result) == moved


class TestArchiveCard:
    def test_archives_card(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        archived = {"id": "c1", "closed": True}
        mock_trello_client.put.return_value = archived

        result = card_tools["archive_card"]("c1")

        mock_trello_client.put.assert_called_once_with("/cards/c1", params={"closed": True})
...
class TestBatchCreateCards:
    def test_creates_multiple_cards(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
    ...
    def test_with_due_date(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
    ...
    def test_empty_cards_list(self, mock_trello_client: MagicMock, card_tools: dict) -> None:
        result = card_tools["batch_create_cards"]([])
