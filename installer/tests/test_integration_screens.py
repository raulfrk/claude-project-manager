...
# TestWriteConfigFiles was deleted in P3 (#672) — InstallerApp._write_config_files
# was removed along with the InstallerApp class. Config writing is now handled
# directly by run_installer_flow in installer/flow/.
