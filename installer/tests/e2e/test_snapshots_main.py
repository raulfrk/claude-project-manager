"""Transition snapshot tests for main flow screens (P4 screens).

Deleted in P3 (#672): PluginSelectScreen, DetectionScreen, UpdateScreen
snapshot tests (screens were ported to plain-Python flow).

Retained: WizardScreen snapshots (P4 territory).
