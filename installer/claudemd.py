...
- **TaskCreate during /proj:run and /proj:execute** — These skills auto-create Tasks for each phase. Spawned agents MUST reference their assigned task_id (passed in the agent prompt) and call TaskUpdate as they progress through the work.
