...
<!-- AUTO:badges-start -->
[![version](https://img.shields.io/badge/version-5.1.0-blue?style=flat-square)](CHANGELOG.md)
...
| [proj](plugins/proj/) | 5.1.0 | productivity | Project lifecycle management: init, explore, status, update, todo, report, archive |
