...
<!-- AUTO:badges-start -->
[![version](https://img.shields.io/badge/version-5.1.8-blue?style=flat-square)](CHANGELOG.md)
...
| [proj](plugins/proj/) | 5.1.8 | productivity | Project lifecycle management: init, explore, status, update, todo, report, archive |
