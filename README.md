...
<!-- AUTO:badges-start -->
[![version](https://img.shields.io/badge/version-5.1.9-blue?style=flat-square)](CHANGELOG.md)
...
|--------|---------|----------|-------------|
| [worktree](plugins/worktree/) | 5.1.1 | utilities | Git worktree management — create, list, and remove worktrees from configured base repositories |
